...
export class SupabaseService {
  ...
  private apiUrl = `${environment.apiUrl}/auth/v1/recover`;
  ...
  signIn(email: string, password: string): Observable<any> {
    ...
    return this.http
      .post(`${environment.apiUrl}/auth/v1/token?grant_type=password`, body, {
        headers,
      })
      .pipe(
        tap((response: any) => {
  ...
  logout(): Observable<any> {
    ...
    return this.http
      .post(`${environment.apiUrl}/auth/v1/logout`, null, { headers })
      .pipe(
        tap(() => {
          this.clearSession();
        })
  ...
  updateUser(
    ...
    return this.http.put(`${environment.apiUrl}/auth/v1/user`, body, {
      headers,
    });
  }
  ...
  getVectorsByUserId(user_id: string): Observable<any> {
    ...
    return this.http.get(
      `${environment.apiUrl}/rest/v1/vectors_table?user_id=eq.${user_id}`,
      { headers }
    );
  }
  ...
  insert(vectorData: any): Observable<any> {
    ...
    return this.http.post(
      `${environment.apiUrl}/rest/v1/vectors_table`,
      vectorDataWithUserId,
      { headers }
    );
  }
  ...
  modificar(vectorId: number, vectorDataUpdated: any): Observable<any> {
    ...
    return this.http.patch(
      `${environment.apiUrl}/rest/v1/vectors_table?id=eq.${vectorId}`,
      vectorDataWithUserId,
      { headers }
    );
  }
